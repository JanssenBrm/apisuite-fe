package = "kong-plugin-api-manager"  -- TODO: rename, must match the info in the filename of this rockspec!
...
local pluginName = package:match("^kong%-plugin%-(.+)$")  -- "api-manager"
