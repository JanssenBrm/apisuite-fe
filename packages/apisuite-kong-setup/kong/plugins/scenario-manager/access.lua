...
function _M.execute(plugin_conf)
  ...
  local scenario_manager = headers[plugin_conf.x_apisuite_scenario_header]
  ...
  if res then
    ...
    if res.headers[plugin_conf.x_apisuite_scenario_header] == -1 then
      ngx.header[plugin_conf.x_apisuite_scenario_header] = nil
      return
    end
