...
describe('(UNIT) PUT /apps/{id}', async () => {
	...
	describe('update an organization app', async () =>{
		...
		describe('Successfully update app', async () =>{
			...
			before(async ()=> {
				...
				stubs.update = stub(appService, 'update')
					.resolves({
						toJSON: () => {
							return {
		...
		describe('Unsuccessfully update app', async () =>{
		...
		describe('Unsuccessfully update app without app id', async () =>{
		...
		describe('Unsuccessfully update app with wrong app id format', async () =>{
		...
		describe('Unsuccessfully update app without name', async () =>{
		...
		describe('Unsuccessfully update app without unique urls', async () =>{
		...
		describe('Unsuccessfully update app without correct scope', async () =>{
