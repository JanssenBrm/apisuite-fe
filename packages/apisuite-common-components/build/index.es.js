import React, { createContext, forwardRef, createElement, Component, Fragment as Fragment$1, useRef, useEffect } from 'react';
...
var $Button = function (_a) {
    ...
    return (React.createElement(Button, __assign({ className: classes.apisButton, variant: "contained" }, rest), children));
};
...
var $Overlay = function (_a) {
    ...
    return (React.createElement(Ie, __assign({ className: classes.overlay }, rest),
        React.createElement("div", { className: classes.nav + " " + (showLogo ? 'spaced' : '') + " " + (noTopBg ? 'transparent' : '') },
            React.createElement("div", { className: classes.logoContainer }, showLogo && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: classes.logo + " " + (blankLogo ? 'blank' : '') },
                    React.createElement(AmpStoriesRoundedIcon, { className: "big-logo" })),
                title))),
            React.createElement("div", { className: classes.clickable, onClick: function () { return onClose(); } },
                React.createElement("div", { className: classes.close }, "close"),
                React.createElement(CloseIcon, null))),
        React.createElement("div", { className: classes.container }, children)));
};

export { $Button as Button, HelloWorld, $Overlay as Overlay };
