import r$1, { useRef, useDebugValue, useContext, createElement, createContext, forwardRef, Component, Fragment as Fragment$1, useEffect } from 'react';
import { Button as Button$1 } from '@material-ui/core';
import i from 'react-dom';
import require$$2 from '@material-ui/core/SvgIcon';

var HelloWorld = function () {
    return r$1.createElement("div", null, "Hello World");
};
...
var Button = function (_a) {
    ...
    return (r$1.createElement($Button, __assign({ variant: "contained" }, rest), children));
};
...
var _react = interopRequireDefault(r$1);
...
var Overlay = function (_a) {
    ...
    return (r$1.createElement($Overlay, __assign({ className: "overlay" }, rest),
        r$1.createElement($Nav, { className: (showLogo ? 'spaced' : '') + " " + (noTopBg ? 'transparent' : '') },
            r$1.createElement($LogoContainer, null, showLogo && (r$1.createElement(r$1.Fragment, null,
                r$1.createElement($Logo, { className: "" + (blankLogo ? 'blank' : '') },
                    r$1.createElement(AmpStoriesRoundedIcon, { className: "big-logo" })),
                title))),
            r$1.createElement($Clickable, { onClick: function () { return onClose(); } },
                r$1.createElement($Close, null, "close"),
                r$1.createElement(CloseIcon, null))),
        r$1.createElement($Container, null, children)));
};
