...
var HelloWorld = function () {
    return React__default['default'].createElement("div", null, "Hello World");
};
    ...
    button: {
        '&.MuiButton-contained': {
            ...
            color: function (props) {
                return (props.btncolor === 'primary' && theme.palette.primaryContrastText) ||
...
var $Overlay = function (_a) {
    ...
    var classes = useStyles$1(rest);
    return (React__default['default'].createElement(Ie, __assign({ className: classes.overlay }, rest),
        React__default['default'].createElement("div", { className: classes.nav + " " + (showLogo ? 'spaced' : '') + " " + (noTopBg ? 'transparent' : '') },
            React__default['default'].createElement("div", { className: classes.logoContainer }, showLogo && (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement("div", { className: classes.logo + " " + (blankLogo ? 'blank' : '') },
                    React__default['default'].createElement(AmpStoriesRoundedIcon, { className: "big-logo" })),
                title))),
            React__default['default'].createElement("div", { className: classes.clickable, onClick: function () { return onClose(); } },
                React__default['default'].createElement("div", { className: classes.close }, "close"),
                React__default['default'].createElement(CloseIcon, null))),
        React__default['default'].createElement("div", { className: classes.container }, children)));
};
