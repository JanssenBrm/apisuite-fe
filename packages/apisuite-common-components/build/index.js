...
var $Button = styled__default['default'](core.Button)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  &.MuiButton-contained {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  :disabled {\n    &.MuiButton-contained.Mui-disabled {\n      background-color: ", ";\n      cursor: default;\n      opacity: 0.6;\n      boxshadow: '0 2px 5px 0 rgba(0,0,0,0.05) !important';\n    }\n  }\n\n  :hover {\n    &.MuiButton-contained {\n      boxshadow: '0 4px 6px 0 rgba(0,0,0,0.35) !important';\n      background-color: ", ";\n    }\n  }\n"], ["\n  &.MuiButton-contained {\n    background-color: ",
    ";\n    color: ",
    ";\n  }\n\n  :disabled {\n    &.MuiButton-contained.Mui-disabled {\n      background-color: ", ";\n      cursor: default;\n      opacity: 0.6;\n      boxshadow: '0 2px 5px 0 rgba(0,0,0,0.05) !important';\n    }\n  }\n\n  :hover {\n    &.MuiButton-contained {\n      boxshadow: '0 4px 6px 0 rgba(0,0,0,0.35) !important';\n      background-color: ",
    ";\n    }\n  }\n"])), function (_a) {
...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement($Button, __assign({ variant: "contained" }, rest), children));
};
...
var Overlay = function (_a) {
    ...
    return (React__default['default'].createElement($Overlay, __assign$1({ className: "overlay" }, rest),
        React__default['default'].createElement($Nav, { className: (showLogo ? 'spaced' : '') + " " + (noTopBg ? 'transparent' : '') },
            React__default['default'].createElement($LogoContainer, null, showLogo && (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement($Logo, { className: "" + (blankLogo ? 'blank' : '') },
                    React__default['default'].createElement(AmpStoriesRoundedIcon, { className: "big-logo" })),
                title))),
            React__default['default'].createElement($Clickable, { onClick: function () { return onClose(); } },
                React__default['default'].createElement($Close, null, "close"),
                React__default['default'].createElement(CloseIcon, null))),
        React__default['default'].createElement($Container, null, children)));
};
