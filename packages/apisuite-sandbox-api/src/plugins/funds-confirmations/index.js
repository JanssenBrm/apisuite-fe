...
/**
 * hapi plugin with funds-confirmations endpoints. Can be used for load balancing purposes.
 * @module plugins/funds-confirmations
 */

/** Configuration object for funds-confirmations endpoints */
exports.plugin = {
	register: (server) => {
		...
		server.route([
			{
				...
				options: handlers.postFundsConfirmations,
			},
		])
	},
	name: 'sandbox-funds-confirmations',
}
